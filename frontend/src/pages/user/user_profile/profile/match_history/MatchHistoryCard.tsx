...
export function MatchHistoryCard(props: MatchHistoryCardProps) {
	return (
		<div>
			<div className="history-user-name ellipsed-txt" title={props.me.username}>@{props.me.username}</div>
			...
			<div className="history-user-name ellipsed-txt" title={props.opponent.username}>@{props.opponent.username}</div>
		</div>
	);
}

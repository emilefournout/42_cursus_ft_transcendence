	...
	if (boardContext === undefined) {
		...
		return (
			<div className="wrapper-col single-col-wrapper">
				<button className="btn game-creation-btn" onClick={() => boardContext?.updateWatchGame()}>reload</button>
				<div className="columns-txt" style={{marginBottom: "8px"}}>Ongoing games:</div>
